export default function NewsLetter() {
    return (
        <div className="pt-20" id="NewsLetter">
            ...
            <span className="font-[400] font-body text-[11.64px] py-3">SUBSCRIBE TO OUR DAILY UPDATES AND NEWSLETTERS</span>
            
            <input type="text" placeholder="ENTER YOUR EMAIL HERE" className="block w-full my-6 text-[10px] text-[#333333] border
            border-black px-2 py-4" />
            
            <button id="subscribe" className="bg-black text-[#FFFFFF] text-[10px] py-4 px-12">SUBSCRIBE</button>
            
            <div className="my-6 flex flex-col gap-4">
                <p className="font-poppins font-[300] text-[11px] py-2">REACH US</p>
                <div className="flex gap-5 items-center">
                    ...
                    <span className="font-body text-[11.64px] font-normal">artsystudios@gmail.com</span>
                </div>
                <div className="flex gap-4 items-center">
                    ...
                    <span className="font-body text-[11.64px] font-normal">Lagos, Nigeria.</span>
                </div>
            </div>           
        </div>
    )
